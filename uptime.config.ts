...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: '聊天',
      method: 'HEAD',
      target: 'https://chat.xhhb.dpdns.org/',
    ...
    },
    {
      ...
      statusPageLink: 'https://nlweb.xiaohuihuib.dpdns.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '密码库',
      method: 'HEAD',
      target: 'https://vault.xhhb.dpdns.org/',
      statusPageLink: 'https://vault.xhhb.dpdns.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
